...
```
forge test --fork-url $YOUR_RPC_URL_HERE
```
...
There are 2 duplivate functions in the code `withdraw` and `cheaperWithdraw`
These examples show how you can optimise the gas savings by utilising memory as opposed to storage.
